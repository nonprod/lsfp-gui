...
#define KCHAR 75 // Char K
#define XCHAR 88 // Char X
#define PCHAR 80 // Char P
#define KCHAR 75 // Char K
#define UCHAR 85 // Char U
#define MCHAR 77 // Char M
#define mCHAR 109 // Char m
#define XCHAR 88 // Char X
#define PCHAR 80 // Char P
#define ZCHAR 90 // Char Z
#define SCHAR 83 // Char S
#define sCHAR 73 // Char s
#define PCHAR 80 // Char P
#define pCHAR 112 // Char p
#define CCHAR 67 // Char C
#define cCHAR 99 // Char c

#define CamFrmSet 34
#define CamStep 45,-83
#define CamForRev 44
#define CamGotoSet 36
#define CamGoto 46
#define ProFrmSet 54
#define ProStep 51,-77
#define ProForRev 49
#define ProGotoSet 55
#define ProGoto 50
#define SysSpdSet 14
#define NumEntZero 30
#define NumEntOne 17
#define NumEntTwo 18
#define NumEntThree 19
#define NumEntFour 21
#define NumEntFive 22
#define NumEntSix 23
#define NumEntSeven 25
#define NumEntEight 26
#define NumEntNine 27
...
// Serial3 comm details 
char firstByte = 0; // firstBytes from serial3?
char secondByte = 0; // secindBytes from serial3?
char panelByte = 0; // Bytes from serial3
char displayByte = 0; // Bytes to probe display
...
void setup() {
  ...
  pinMode(TX3, OUTPUT); // Pin for output to panel
  pinMode(RX3, INPUT); // Pin for input from panel
  ...
  Serial3.begin(9600); // FP speed 9600
...
void loop() { //to get the full TOTALSTEPS = 2000, takes about .25 seconds. // - 1 number is depth of nesting "{"
  ...
  /*
  // test for FP
if(Serial3.available() > 0) { // - 3 Any characters entered
  Serial3.write(XCHAR);
  delay(500);
  Serial3.write(KCHAR);
  Serial3.read();
  ...
  while(waiting) { // - 2 waiting for command entry
    if(Serial.available() > 0) { // - 3 Any characters entered
      ...
      if(incomingByte == SYSLOCK) { // FP 8 - 4
        camsel = true;
        projsel = true;
